...
public class PicoDonationaroundmemapAdapter extends RecyclerView.Adapter<PicoDonationaroundmemapAdapter.MyViewHolder> {

    private ArrayList<Product> arrayList=new ArrayList<>();
    private Context context;


    public PicoDonationaroundmemapAdapter(ArrayList<Product> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public PicoDonationaroundmemapAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.adapter_pico_mapdonationaroundme, viewGroup, false);

        return new PicoDonationaroundmemapAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull PicoDonationaroundmemapAdapter.MyViewHolder myViewHolder, final int i) {
        ...
        Log.d("mapaddress",product.getAddress());
...
//        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_distance,
                //unit,
                weight,title,addr,status,availabletxt,type_dstxt;
        RatingBar ratingBar;
        CardView cv_main;
