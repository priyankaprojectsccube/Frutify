...
public class GardenAdapter extends RecyclerView.Adapter<GardenAdapter.MyViewHolder> {
    ...
    public GardenAdapter(ArrayList<AllProductPojo> allProductPojos, Context mctx) {
    ...
    public GardenAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GardenAdapter.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(@NonNull GardenAdapter.MyViewHolder holder, int position) {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObject.getString("status").equals("1")) {
                                        Intent intent = new Intent(mctx, MyGardenActivity.class);
        ...
        holder.give.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mIntent = new Intent(mctx, AntiAddofferActivity.class);
...
//        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView img;
        TextView cat, subcat, deletegarden, sell,give;
