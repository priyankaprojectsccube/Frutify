...
public class MyGardenImageHelperClass implements Serializable {
    ...
    public ArrayList<MyGardenImageHelperClass> getmImgArr() {
        return mImgArr;
    }

    public void setmImgArr(ArrayList<MyGardenImageHelperClass> mImgArr) {
    ...
    private ArrayList<MyGardenImageHelperClass> mImgArr = new ArrayList<>();
