...
public class NotificationPicoAdapter extends RecyclerView.Adapter<NotificationPicoAdapter.MyViewHolder> {

    private ArrayList<Product> arrayList=new ArrayList<>();
    private Context context;


    public NotificationPicoAdapter(ArrayList<Product> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public NotificationPicoAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.adapter_notilayout, viewGroup, false);

        return new NotificationPicoAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull NotificationPicoAdapter.MyViewHolder myViewHolder, final int i) {
