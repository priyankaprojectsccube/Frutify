...
public class AllProductsearchAdapter extends RecyclerView.Adapter<AllProductsearchAdapter.MyViewHolder> {
ArrayList<AllProductPojo> allProductPojos;
Context mctx;


    public AllProductsearchAdapter(ArrayList<AllProductPojo> allProductPojos, Context mctx) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_all_productssearch, parent, false);

        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AllProductsearchAdapter.MyViewHolder holder, int position) {
        ...
        Log.d("offmap",items.getPrice()+" "+items.getOffer_type());
