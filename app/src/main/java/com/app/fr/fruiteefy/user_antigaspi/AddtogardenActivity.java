...
public class AddtogardenActivity extends AppCompatActivity implements Spinner.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getResources().getString(R.string.addtomygarden));
        ...
        stringRequest=new StringRequest(Request.Method.POST, BaseUrl.BASEURL.concat("get_anti_category"), new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("user_id", PrefManager.getUserId(AddtogardenActivity.this));
                return param;
            }
        ...
        addtogarden.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(category_id.equals("")){
                    Toast.makeText(AddtogardenActivity.this, getResources().getString(R.string.selectcat), Toast.LENGTH_SHORT).show();
                }

                else if(subcategory_id.equals("")){
                    Toast.makeText(AddtogardenActivity.this, getResources().getString(R.string.selectsubcat), Toast.LENGTH_SHORT).show();
                }

                else{

                    RequestQueue  requestQueue3=Volley.newRequestQueue(AddtogardenActivity.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(jsonObject.getString("status").equals("1")) {
                                    ...
                                    Intent intent = new Intent(AddtogardenActivity.this, MyGardenActivity.class);
                                    startActivity(intent);
                                    finish();
                                }
                                Toast.makeText(AddtogardenActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
